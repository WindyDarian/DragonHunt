...
#include "DragonHunt.h"
#include "DragonHuntHelperLibrary.h"

#include <limits>

FVector UDragonHuntHelperLibrary::RotateTowardsRandomDirection(FVector Origin, float Angle)
{
...
FVector UDragonHuntHelperLibrary::CalculateProjectileDirection(FVector Target, FVector Origin, FVector Gravity, float Speed, bool & bWillHit, float & Time)
{
